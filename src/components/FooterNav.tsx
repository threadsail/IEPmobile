...
const items: { label: string; href: string; icon: React.ReactNode }[] = [
  ...
  },
  {
    ...
    icon: (
      <svg className={iconClass} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M4.26 10.147a60.436 60.436 0 00-.491 6.347A48.627 48.627 0 0112 13.803a48.627 48.627 0 017.74-3.342 60.46 60.46 0 00-.491-6.347m-15.482 0a50.57 50.57 0 00-2.658-.813A59.905 59.905 0 0112 3.493a59.902 59.902 0 0110.399 5.84 50.567 50.567 0 00-2.658.814m-15.482 0A50.697 50.697 0 0112 13.489a50.702 50.702 0 017.74-3.342 50.697 50.697 0 00-2.658-.814M12 20.25a48.746 48.746 0 00-8.314-4.192 50.99 50.99 0 008.314 4.192 50.99 50.99 0 008.314-4.192 48.746 48.746 0 00-8.314 4.192" />
      </svg>
    ),
  },
];
