...
const iconClass =
  "mx-auto h-5 w-5 shrink-0 transition-[width,height] duration-200 ease-out md:h-6 md:w-6";

export type TabColor = "blue" | "teal" | "orange" | "purple" | "pink";
...
> = {
  ...
  teal: {
    active:
      "bg-gradient-to-br from-teal-400 to-teal-600 text-white hover:bg-teal-600 dark:bg-teal-600/90 dark:hover:bg-teal-600",
    inactive:
      "text-zinc-700 hover:bg-white/20 hover:text-teal-600 dark:text-zinc-300 dark:hover:bg-black/20 dark:hover:text-teal-500",
  },
  orange: {
    active:
      "bg-gradient-to-br from-orange-300 to-orange-500 text-white hover:bg-orange-500 dark:bg-orange-600/90 dark:hover:bg-orange-600",
    inactive:
      "text-zinc-700 hover:bg-white/20 hover:text-orange-600 dark:text-zinc-300 dark:hover:bg-black/20 dark:hover:text-orange-500",
  },
  purple: {
    active:
      "bg-gradient-to-br from-purple-400 to-purple-600 text-white hover:bg-purple-600 dark:bg-purple-600/90 dark:hover:bg-purple-600",
    inactive:
      "text-zinc-700 hover:bg-white/20 hover:text-purple-600 dark:text-zinc-300 dark:hover:bg-black/20 dark:hover:text-purple-500",
  },
  pink: {
    active:
      "bg-gradient-to-br from-pink-400 to-pink-600 text-white hover:bg-pink-600 dark:bg-pink-600/90 dark:hover:bg-pink-600",
    inactive:
      "text-zinc-700 hover:bg-white/20 hover:text-pink-600 dark:text-zinc-300 dark:hover:bg-black/20 dark:hover:text-pink-500",
  },
};
